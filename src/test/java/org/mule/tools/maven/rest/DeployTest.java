...
public class DeployTest {
	...
	when(mockMuleRest.restfullyCreateDeployment(anyString(), anyString(), anyString(), anyString())).thenReturn(DEPLOYMENT_ID);
    }
	...
	verify(mockMuleRest).restfullyCreateDeployment(SERVER_GROUP, null, NAME, VERSION_ID);
